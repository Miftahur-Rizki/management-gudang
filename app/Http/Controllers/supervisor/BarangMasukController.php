...
class BarangMasukController extends Controller
{
    public function index()
    {
        ...
        return view('supervisor.barang-masuk.index', compact('data'));
    }

    public function create()
    {
        return view('supervisor.barang-masuk.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supervisor.barang-masuk.index')
            ->with('success', 'Data berhasil ditambahkan');
    }

    public function edit($id)
    {
        $data = BarangMasuk::with('product')->findOrFail($id);
        ...
        return view('supervisor.barang-masuk.edit', compact('data'));
    }
